...
function sendMail (e) {
    ...
    if (mail && message && name) {
        ...
        Email.send({
            ...
            Username: "lucashidehb@gmail.com",
            Password: "CD6D38FBC8623CE2DCED3040D94FA3630A6D",
            To: "lucashidehb@gmail.com",
            From: "lucashidehb@gmail.com",
            Subject: `Novo contato - Portifólio ${name} `,
            Body: `Email: ${mail} \n \n ${message}`,
          }).then(() => {
